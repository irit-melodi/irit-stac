...
time_of_creation = str(datetime.datetime.now())
	...
	if curr_turn_emitter != "Server":
		...
		if len(seg_leftborders) == len(seg_rightborders):
			for k in range(0,len(seg_leftborders)):
				...
				selfAddressee = SubElement(selfset, 'feature', {'name':'Addressee'}) # Surface act
				selfAddressee.text = ''
				selfSurfaceAct = SubElement(selfset, 'feature', {'name':'Surface_act'})
				selfSurfaceAct.text = 'Please choose...'
				selfTaskAct = SubElement(selfset, 'feature', {'name':'Task-related_act'})
				selfTaskAct.text = 'Please choose...'
				selfOfferMaker = SubElement(selfset, 'feature', {'name':'Offer::Maker'})
				selfOfferMaker.text = 'N/A'
				selfOfferTaker = SubElement(selfset, 'feature', {'name':'Offer::Receiver'})
				selfOfferTaker.text = 'N/A'
				selfOfferGivenRes = SubElement(selfset, 'feature', {'name':'Offer::Resources_given'})
				selfOfferGivenRes.text = 'N/A'
				selfOfferTakenRes = SubElement(selfset, 'feature', {'name':'Offer::Resources_received'})
				selfOfferTakenRes.text = 'N/A'
